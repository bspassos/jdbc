...
insert into equipamento (id,  nome, mensalidade) values (null, 'Desktop Dell', 300);
insert into equipamento (id,  nome, mensalidade) values (null, 'Impressora HP', 100);
insert into equipamento (id,  nome, mensalidade) values (null, 'Monitor 23', 50);
